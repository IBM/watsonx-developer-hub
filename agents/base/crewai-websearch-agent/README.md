...
This repository provides a basic template for LLM apps built using CrewAI framework. It also makes it easy to deploy them as an AI service as part of _IBM watsonx.ai_ for IBM Cloud and _IBM watsonx.ai software_ for IBM Cloud Pak® for Data[^1].  
