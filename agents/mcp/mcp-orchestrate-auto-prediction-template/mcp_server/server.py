...
DeploymentInput = create_input_model()
...
def _build_tool_description() -> str:
    ...
    return (
        f"Predict the value of '{prediction_column}' using the deployed watsonx.ai model.\n\n"
...
def invoke_prediction(input_data: DeploymentInput):
